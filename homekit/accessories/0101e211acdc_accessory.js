...
var options = {
  ...
  clientId: '0101e211acdc' //muda aqui para cada novo dispositivo
};
var client = mqtt.connect(options);
console.log('Dispositivo Conectado para MQTT broker');

client.subscribe('/house/confirma/0101e211acdc');
...
var LAMPADA_AUTOHOME = {
  ...
  setPowerOn: function(on) {
    ...
    if (on) {
      client.publish('/house/iluminacao/0101e211acdc', '1', {retain: true});   //Topico a Ser alterado
      LAMPADA_AUTOHOME.powerOn = on;
   	}
    else {
	    client.publish('/house/iluminacao/0101e211acdc','0', {retain: true});   //Topico a ser alterado
      LAMPADA_AUTOHOME.powerOn = false;
   };
...
var lightUUID = uuid.generate('hap-nodejs:accessories:rerr');

// This is the Accessory that we'll return to HAP-NodeJS that represents our fake light.
var light = exports.accessory = new Accessory('rerr', lightUUID);


// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
light.username = '01:01:e2:11:ac:dc:5D:EC';
light.pincode = '446-13-665';
...
light
  .addService(Service.Lightbulb, 'rerr') // services exposed to the user should have 'names' like 'Fake Light' for us
